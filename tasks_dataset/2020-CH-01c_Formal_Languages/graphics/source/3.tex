...
\usepackage{lmodern}
\usepackage[margin=2mm,paperwidth=9.8cm,paperheight=8.3cm]{geometry}
...
%      \node[state] (1) [left of=0]      {};
%      \node[state] (2) [left=4cm of 1]  {};
%      \node[state] (3) [above right=2cm and 1cm of 2] {End};
%      \path[->] (0) edge[bend right] node[swap] {Jup-pi} (1)
...
%  \begin{center}
    \begin{tikzpicture}[node distance=3cm]
      ...
      \path[->] (0) edge[bend left] node {La La} (1)
                ...
                (4) edge[bend right] node[swap] {La La La} (1)
