...
const ageList: Age[] = [
  { id: 0, title: "8-10ans", db: "8-10", isChecked: false },
  { id: 1, title: "10-12ans", db: "10-12", isChecked: false },
  { id: 2, title: "12-14ans", db: "12-14", isChecked: false },
  { id: 3, title: "14-16ans", db: "14-16", isChecked: false },
  { id: 4, title: "16-19ans", db: "16-19", isChecked: false },
];
...
export default function AgeCategoriesFilter() {
  ...
  const initialAges = ageList.map((age) => ({
    ...age,
    isChecked: params.get("age") === age.db,
  }));

  const [age, setAge] = useState(initialAges);

  function handleToggleAges(ageID: number, nextCheck: boolean) {
    const updatedAges = age.map((age) =>
      age.id === ageID
    ...
    const updatedQuery = {
      ...
      age: selectedAge?.isChecked ? selectedAge.db : undefined,
    };
